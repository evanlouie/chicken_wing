...
class RevisionsControllerTest < ActionController::TestCase
  ...
  #     post :create, revision: { commit_id: @revision.commit_id, project_id: @revision.project_id }
  #   end
  #
  ...
  #   patch :update, id: @revision, revision: { commit_id: @revision.commit_id, project_id: @revision.project_id }
  #   assert_redirected_to revision_path(assigns(:revision))
  # end
  #
